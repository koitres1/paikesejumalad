        ...
        $.get("https://www.googleapis.com/youtube/v3/search?key=" + key + "&type=video&part=snippet&maxResults=" + maxResults + "&q=" + search, function (data) {
            ...
            data.items.forEach(item => {
                video = `
                        ...
                        <iframe width = "420" height = "315" src ="https://www.youtube.com/embed/${item.id.videoId}?enablejsapi=1&autoplay=1&loop=1&origin=https://www.youtube.com" frameborder="0" allowfullscreen></iframe>
